...
### 1. Start Here
- **Cover icon:** ▶︎ play / Gulfio mark
- **Purpose:** 30-second 'what Gulfio is' for first-time visitors
- **Feed it with:**
  - What Gulfio covers (news + football + weather)
  - Link sticker → gulfio.app

### 2. Top Stories
- **Cover icon:** 📰 newspaper
- **Purpose:** The best of this week's Gulf & MENA news — proof the feed is fresh
- **Feed it with:**
  - Daily headline cards
  - Trending regional stories
